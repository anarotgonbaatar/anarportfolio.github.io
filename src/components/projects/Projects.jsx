    ...
    <div className='section' id='projects'>
      ...
      <div id="projects-container">
        <div className="project-card">
          <img src={Grabngo} className='project-cover' alt='project cover' />
        ...
        <div className="project-card">
          <img src={Hungmen} className='project-cover' alt='project cover' />
          <div className='project-header'>
        ...
        <div className="project-card">
          <img src={Portfolio} className='project-cover' alt='project cover' />
          <div className='project-header'>
